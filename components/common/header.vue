...
export default {
    ...
    mounted() {
        ...
        //         var menuToggleLink = menuToggle.querySelector('.Header-menu-item.active .Header-menu-item-link');
        //         if (menu && menuToggleLink && !menu.contains(event.target) && !menuToggleLink.contains(event.target)) {
