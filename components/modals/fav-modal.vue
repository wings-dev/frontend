<template>
  <!-- Fav Modal -->
  <b-modal id="favModal" class="Login" size="xl" :hide-header="true" hide-footer>
    <div class="Login">
      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" @click="$bvModal.hide('favModal')"><i
      ...
      <div class="Login-in">
        ...
        <div class="Login-right">
          <div class="Login-right-in">
            <div class="Login-fav">
              <nuxt-img src="/img/fav-heart-big.svg" alt="" loading="lazy" placeholder ></nuxt-img>
