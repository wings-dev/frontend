                    ...
                    <div class="tab-pane fade show active" id="pills-beach" role="tabpanel"
                      ...
                      <div class="first-tab-item" v-for="(item, index) in places.beaches"
                        ...
                        <div class="first-tab-item-img" v-if="item.images && item.images.length">
                          <nuxt-img :src="item.images[0].preview_url" width="157" height="95" loading="lazy" placeholder :alt="villa_prefix + villa.code + ' ' + sitename"
                            v-if="item.images && item.images.length > 0"></nuxt-img>
                          <nuxt-img src="/img/tesis-yok.png" :alt="villa_prefix + villa.code + ' ' + sitename" width="157" height="95" loading="lazy" placeholder  v-else></nuxt-img>
                        </div>
                  ...
                  <div class="View-reviews-item-bottom">
                    ...
                    <div class="View-reviews-item-bottom-right">
                      <a href="/img/reviews.png" class="View-reviews-item-bottom-right-item" data-fancybox="reviews">
                        <nuxt-img src="/img/reviews.png" :alt="villa_prefix + villa.code + 'Yorumlar ' + sitename" loading="lazy" placeholder ></nuxt-img>
                      </a>
                      <a href="/img/reviews.png" class="View-reviews-item-bottom-right-item" data-fancybox="reviews">
                        <nuxt-img src="/img/reviews.png" :alt="villa_prefix + villa.code + 'Yorumlar ' + sitename" loading="lazy" placeholder ></nuxt-img>
                      </a>
                    ...
                    <div class="tab-pane fade show active" id="pills-beach" role="tabpanel"
                      ...
                      <div class="first-tab-item" v-for="(item, index) in places.beaches">
                        <div class="first-tab-item-img" v-if="item.images && item.images.length > 0">
                          <nuxt-img :src="item.images[0].preview_url" :alt="villa_prefix + villa.code + ' ' + sitename" width="157" height="95" loading="lazy" placeholder 
            ...
            <div class="Gallery-list">
              <template v-for="(floor, index) in villa.floorplan.kat">
                <button v-if="bolum.gorsel && bolum.gorsel.length" type="button" class="Gallery-list-item"
                  ...
                  <nuxt-img :src="bolum.gorsel[0].preview_url" class="w-100" :alt="villa_prefix + villa.code + ' ' + sitename" loading="lazy" placeholder ></nuxt-img>
